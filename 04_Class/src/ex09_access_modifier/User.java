...
public class User {
	...
	/*
	 	접근 제어 지시자(Access Modifier)                (1번과 4번만 주로 사용한다.)
	...
	/*
	  	...
	  	2. 클래스의 내부 정보는 "필드"를 의미하므로 "필드값"을 외부에 공개하지 하는 것을 말한다.
	...
	// get , set는 위 source 메뉴에서 Generate에 getter and setter를 클릭후 생성한다. (수기로 작성하는것이 아니다)
