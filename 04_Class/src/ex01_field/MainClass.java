...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		System.out.println("주소 : "  + user1.addr.postcode + " " + user1.addr.rodeAddress + "(" + user1.addr.jibunAddress + ")");
		...
		System.out.println("주소 : "  + user2.addr.postcode + " " + user2.addr.rodeAddress + "(" + user2.addr.jibunAddress + ")");
