...
public class MainClass {
	...
	/*
		 	...
		 	2. 용어 정리
		 		1) Entry  : 하나의 데이터
		 		2) Key	  : Entry의 구성 요소, 식별자 역할을 수행(배열의 인덱스와 같은 역할을 수행함) String 변수라고 보면 됌
		 		3)Value	  : Entry의 구성 요소, 실제 데이터(배열에 저장된 데이터와 같은 역할을 수행함)
	...
	public static void ex01() {
		...
		// 삭제
		//remove(Key)
		int age = (int)person.remove("age");	// 삭제된 Value가 반환된다. Vlaue는 Object 타입이므로 캐스팅해야 사용할 수 있다.
