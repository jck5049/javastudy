...
public class MainClass {
	...
	/*
		 	 try - catch - resources문 		ex03번에 정리되어있음 (코드)
	...
	public static void ex02() {		// 내가 그냥 작업한 메소드
		
		
		File dir = new File("C:" + File.separator + "jjc");
		if(dir.exists() == false) {
			dir.mkdirs();
		}
		
		File file = new File(dir, "spem.txt");
	...
	public static void ex04() {
		...
		/*
		 	BufferedWriter
		 	1. 자체 기억장소를 갖춘 Writer
		 	2. 내부 버퍼를 가지고 있는 Writer이다.
		 	3. 속도 향상을 위해서 사용한다.
		 	4. 보조 스트림이므로 메인 스트림과 함께 사용해야 한다.
		 */
	...
	public static void ex05() {		// ex04번 코드를 try-catch-resources로 바꾼다
