...
public class MainClass {
	...
	public static void ex01() {
		...
		try {
			...
			fos = new FileOutputStream(file);	// int , byte[ ]만 입력이 가능하다 OutputStream 이 작업시!
			
			// 출력 단위 
			// 1. int	: 1개
			// 2. byte	: 2개 이상 -> 아래 스트링으로 설정하고 그 아래 byte배열로 변경해주기! getBytes()를 사용해서
	...
	public static void ex02() {
		...
		try {
			...
			// getBytes(Charset charset)		java 1.7부터 사용가능
